...
const corsOptionsDev = {
  credentials: true,
  origin: [ "http://localhost:3001", "http://ec2-54-204-147-154.compute-1.amazonaws.com", "http://grp7-unselected.s3-website-us-east-1.amazonaws.com" ],
  methods: ["POST", "GET", "PUT", "DELETE"],
};
const corsOptionsProd = {
  credentials: true,
  allowedHeaders: ["Accept", "Content-Type"],
  origin: [ "http://ec2-54-204-147-154.compute-1.amazonaws.com", "http://grp7-unselected.s3-website-us-east-1.amazonaws.com" ],
