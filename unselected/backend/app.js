...
const app = express();
const port = process.env.UNSELECTED_PORT | 5002;
...
const corsOptionsDev = {
  credentials: true,
  origin: [ "http://localhost:3000", "http://localhost:3001", "http://ec2-3-80-132-7.compute-1.amazonaws.com", "http://grp7-unselected.s3-website-us-east-1.amazonaws.com" ],
  methods: ["POST", "GET", "PUT", "DELETE", "OPTIONS"],
};
const corsOptionsProd = {
  credentials: true,
  allowedHeaders: ["Accept", "Content-Type"],
  origin: [ "http://ec2-3-80-132-7.compute-1.amazonaws.com", "http://grp7-unselected.s3-website-us-east-1.amazonaws.com" ],
